...
const navigate = useNavigate()
  ...
  return (
    <div className="header">
      ...
      <div className="medio">
        <p>
          He creado unos cuantos retos matemáticos y de lógica para entrenarte 
          la mente.Parecen faciles pero te haran pensar un poco, intenta acertarlos y acabar el recorrido.
        </p>
      </div>
